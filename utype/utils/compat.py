...
__all__ = ['get_origin', 'get_args', 'ForwardRef', 'is_final',
           'is_union', 'is_classvar', 'evaluate_forward_ref']
...
def _check_final(v) -> bool:
    return type(v) == type(Final) and (sys.version_info < (3, 7) or getattr(v, '_name', None) == 'Final')
